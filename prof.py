...
def creaFinestra():
    ...
    wip.iconbitmap("sld_icon_beta.ico")
        ...
        if prof[x]["imageURI"]=="":
            ...
            if os.path.exists(prof[x]["imageURI"]):
                ...
                tkmb.showwarning(_("Immagine non esistente!"),
                               message=_("Non esiste una immagine per il professore {}! Molto probabilmente l'hai spostata o eliminata. Per risolvere selezionare nuovamente l'immagine modificando il professore oppure spostarla nella cartella precedente.".format(prof[x]["nome"]+" "+prof[x]["cognome"])))
    li=Label(wip,text=_("Per aggiungere un professore, usa il tasto destro del mouse su uno spazio vuoto della finestra.\nPer modificare un professore, fai doppio click sulla riga corrispondente.\nPer modificare o eliminare un professore, selezionare una riga e poi premere il tasto destro del mouse"))
    li.pack()
