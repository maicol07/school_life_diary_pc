...
class Calendar(ttk.Frame):
    ...
    def __init__(self, master=None, year=None, month=None, firstweekday=calendar.MONDAY, locale=None,
        ...
        # custom ttk styles
        style1 = ttk.Style()
        style1.layout('L.TButton', (
            [('Button.focus', {'children': [('Button.leftarrow', None)]})]
        ))
        style1.layout('R.TButton', (
    ...
    def _build_calendar(self, year, month):
        ...
        if self._selected_date is not None and self._selected_date.year == self._year and \
                self._selected_date.month == self._month:
    ...
    def next_month(self):
        ...
        date = self.datetime(self._year, self._month, 1) + self.timedelta(days=calendar.monthrange(self._year,
                                                                                                   self._month)[1] + 1)
